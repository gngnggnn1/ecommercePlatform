  ...
  <el-table class = "table"
    ...
    <el-table-column label="操作" align="center">
        <template slot-scope="scope11">
          <el-button type="primary" size="mini" @click="handleEdit(scope11.$index, scope11.row)">编辑</el-button>
...
<el-dialog title="编辑菜单" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    ...
    <el-form-item label="资源路径" :label-width="formLabelWidth">
      <el-input v-model="form.menu_url" autocomplete="off" :disabled=" this.form.menu_url == '#' ? false : true "></el-input>
    </el-form-item>
