<template>
  <div class="pageContent">
    ...
    <div class="pageHeader" style="padding: 15px">
      <h1 style="color: #2679b5;font-size: 24px;font-weight: normal margin:15px">
        ...
        <small style="font-size: 14px; color: grey">
          <font-awesome-icon :icon="['fas','angle-double-right']" size="2px" />商品分类主图
        </small>
      </h1>
    </div>
    ...
    >
      ...
      <template slot-scope="scope">
        <img :src="scope.row.brandLogo" width="40" height="40"/>
      </template>
      </el-table-column>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
    ...
    <el-button type="primary" @click="dialogVisible = true" style="float: right; margin-right: 20px">新增</el-button>

    <el-dialog title="品牌信息" :visible.sync="dialogVisible" width="50%">
