...
export default {
  data() {
    return {
      dialogVisible: false,
      form:{},
      tableData: [{view: require('https://ykimg.alicdn.com/develop/image/2020-07-10/ba5fe94735f59d6c676723dc2996c5ad.jpg?x-oss-process=image/resize,w_290/interlace,1/quality,Q_80/sharpen,100')}
