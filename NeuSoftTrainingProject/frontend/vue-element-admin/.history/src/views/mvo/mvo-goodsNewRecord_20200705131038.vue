  ...
  <div class="pageContent">
    ...
    >
      ...
      <el-form-item prop="upcCode">
        ...
        <el-input class="formInput" v-model="ruleForm.upcCode" style="width: 200px"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        skuCode: [
          { required: true, message: "品牌商可以选择不提供UPC和EAN码 eBay网店不一定需要UPC码，amazon网店通常自己再另外为借卖商品申请UPC码，这样可以让商品独立销售，如果amazon网店不为借卖商品另外申请UPC码，将以跟卖商品销售商品。", trigger: "blur" }
        ],
        upcCode: [
          {required: true, message: "UPC码也是用于商品的条码，主要用于美国和加拿大地区，UPC条码是由美国统一代码委员会制定的一种条码。出口到北美地区为了适应北美地区的需要，也需要申请UPC条码，UPC条码也有标准版和缩短版两种，标准版由12位数字构成，缩短版由8位数字构成。", trigger: "change" }
        ],
      }
    };
  },
