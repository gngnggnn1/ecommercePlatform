<template>
  <div class="pageContent">
    ...
    >
      ...
      <div style="margin-left:18%; margin-top:0px; margin-bottom:20px; font-size: 14px; color: blue"> 
      ...
      <div style="margin-left:18%; margin-top:0px; margin-bottom:20px; font-size: 14px; color: orange"> 
          商品质保承诺将大大提升市场信心（可不提供）
        </div>

<div style="margin-left:18%; margin-top:0px; font-size: 14px; color: orange"> 
          注意：在eBay网店，商品详情可以利用图片+文字的方式推送
        </div>
        <el-form-item prop="eBayDescription" style="height:350px;">
        <span slot="label">
          eBay description
        </span>
        <quill-editor v-model="ruleForm.eBayDescription" style="height:260px;" :options="editorOption"></quill-editor>
      </el-form-item>

    <div style="margin-left:18%; margin-top:0px; font-size: 14px; color: orange"> 
          在Amazon网店，目前只允许白金级别网店以图片+文字方式推送，其余将删除图片，只推送纯文字
        </div>
        <el-form-item prop="amazonDescription:" style="height:350px;">
        <span slot="label">
          Amazon description:
        </span>
        <quill-editor v-model="ruleForm.amazonDescription" style="height:260px;" :options="editorOption"></quill-editor>
      </el-form-item>      
...
export default {
  data() {
    return {
        ...
        editorOption:{placeholder: "在Amazon网店，目前只允许白金级别网店以图片+文字方式推送，其余将删除图片，只推送纯文字"},
      rules: {
        commodityName: [
