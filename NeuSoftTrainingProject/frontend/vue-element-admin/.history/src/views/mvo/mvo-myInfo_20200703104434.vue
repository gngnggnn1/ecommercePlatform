<template>
  <div class="pageContent">
    <div class="pageHeader" style="magin: 5%">
        <h1 style="color: #2679b5;font-size: 24px;font-weight: normal margin-left:15px">品牌商<small style="font-size: 14px"><i class="icon-double-angle-right"></i> 公司信息</small></h1>
    </div>
    <el-form
      :model="ruleForm"
      :rules="rules"
