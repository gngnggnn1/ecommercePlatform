<template>
  <div class="pageContent">
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="companyNameZh" label="Company Name 公司名称(中文)" width="160"></el-table-column>
      <el-table-column prop="companyNameEn" label="Company Name 公司名称(英文)" width="160"></el-table-column>
