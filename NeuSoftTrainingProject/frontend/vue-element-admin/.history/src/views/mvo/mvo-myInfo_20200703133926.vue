<template>
  <div class="pageContent">
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="companyNameZh" label="Company Name 公司名称(中文)" width="200"></el-table-column>
      <el-table-column prop="companyNameEn" label="Company Name 公司名称(英文)" width="200"></el-table-column>
      <el-table-column prop="gmcType" label="GMC Report Type品牌商认证类型" show-overflow-tooltip></el-table-column>
      <el-table-column prop="gmcUrl" label="GMC Report Url证书地址" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column
      prop="brandName"
      label="品牌名称Brand Name"
      width="120">
    </el-table-column>
    <el-table-column
      prop="brandLogo"
      label="品牌图片Brand Logo"
      width="120">
    </el-table-column>
    <el-table-column label="操作">
      <template slot-scope="scope">
