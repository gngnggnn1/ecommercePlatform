<template>
  <div class="pageContent">
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="companyNameZh" label="Company Name/公司名称(中文)" width="200px" :render-header="renderheader"></el-table-column>
      <el-table-column prop="companyNameEn" label="Company Name/公司名称(英文)" width="200px" :render-header="renderheader"></el-table-column>
      <el-table-column prop="gmcType" label="GMC Report Type/品牌商认证类型" :render-header="renderheader" show-overflow-tooltip></el-table-column>
      <el-table-column prop="gmcUrl" label="GMC Report Url/证书地址" :render-header="renderheader" show-overflow-tooltip></el-table-column>
