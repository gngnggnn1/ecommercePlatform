<template>
  <div class="pageContent">
    ...
    >
      ...
      <el-table-column prop="brandName" label="品牌名称/Brand Name" width="120" align="center" :render-header="renderheader"> </el-table-column>
      <el-table-column prop="brandLogo" label="品牌图片/Brand Logo" width="120" align="center" :render-header="renderheader"></el-table-column>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
