...
export default {
  ...
  methods: {
    ...
    handleWithdraw(){
      ...
      let waf_ = {}
      waf_ = this.form1
      alert(parseFloat(this.form1.available_money )- parseFloat(this.withdrawForm.available_money))
      waf_['available_money'] = parseFloat(this.form1.available_money )- parseFloat(this.withdrawForm.available_money) 
      ...
      wta_['withdrawing_money_after'] = parseFloat(this.form1.withdrawing_money) + parseFloat(this.withdrawForm.withdrawing_money)
      wta_['status'] = 2
