...
<script>
import { getWalletInfo, searchBusinessFlow, chargeAndDeposit} from "@/api/wallet";
export default {
  data() {
    return {
      username:'',
  ...
  methods: {
    ...
    handleWithdraw(){
      ...
      let waf_ = {}
      waf_ = this.form1
      waf_['available_money'] = parseFloat(this.form1.available_money )- parseFloat(this.withdrawForm.withdrawing_money) 
