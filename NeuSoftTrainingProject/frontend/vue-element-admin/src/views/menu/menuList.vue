...
<el-dialog title="编辑菜单" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    ...
    <el-form-item label="图标" :label-width="formLabelWidth">
      <e-icon-picker v-model="form.menu_icon"/>
    </el-form-item>
  </el-form>
...
<el-dialog title="新增菜单" :visible.sync="dialogFormVisible1">
  <el-form :model="form1">
    ...
    <el-form-item label="父级菜单id" :label-width="formLabelWidth">
      <el-input v-model="form1.parent_id" autocomplete="off" :disabled="isFather"></el-input>
    </el-form-item>
    <el-form-item label="资源路径" :label-width="formLabelWidth">
    ...
    <el-form-item label="图标" :label-width="formLabelWidth">
      <e-icon-picker v-model="form1.menu_icon"/>
    </el-form-item>
  </el-form>
  <div slot="footer" class="dialog-footer">
...
<script>
    ...
    import { deleteByUrlAndName, updateById, addMenu, deleteById } from '@/api/menu'
  ...
  export default {
    ...
    methods: {
        ...
        handleDelete2(index,row){
          ...
          deleteById(row.menu_id).then(res =>{
            if(res.data==1){
              alert("删除成功")
            }
            else{
        ...
        handleChangeRadio(val){
          this.isFather = (val === '1')?true:false
        }
    }
  }
</script>
