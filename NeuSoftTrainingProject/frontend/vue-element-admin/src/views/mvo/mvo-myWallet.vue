...
export default {
  ...
  methods: {
    ...
    handleWithdraw(){
      if(this.form1.available_money < this.withdrawForm.withdrawing_money){
        alert("余额不足")
      }
      else{      let request = {}
      let waa_ = {}
      ...
      let waf_ = {}
      waf_['buyer_id'] = this.buyer_id
      waf_['currency'] = this.form1.currency
      waf_['available_money'] = this.form1.available_money 
      waf_['withdrawing_money'] = parseFloat(this.form1.withdrawing_money) + parseFloat(this.withdrawForm.withdrawing_money)
      waf_['depositing_money'] = this.form1.depositing_money
      ...
      wta_['operate_type'] = 2
      wta_['operate_money'] = this.withdrawForm.withdrawing_money
      wta_['status'] = 2
      ...
      wtr_['balance'] = this.form1.available_money
      wtr_['transaction_type'] = 2
      wtr_['status'] = 2
      wtr_['transaction_money'] = this.withdrawForm.withdrawing_money
      wtr_['finance_type'] = 2
      wtr_['create_time'] =  dateFormat("YYYY-mm-dd HH:MM:SS", new Date()) 
    ...
    handleDeposit(){
      ...
      wta_['last_update_time'] =  dateFormat("YYYY-mm-dd HH:MM:SS", new Date()) 
      wta_['operate_type'] = 1
      wta_['operate_money'] = this.depositForm.depositing_money
      let wtr_ = {}
      wtr_['buyer_id'] = this.buyer_id
      wtr_['account_name'] = this.form.account_name
      wtr_['balance'] = this.form1.available_money
